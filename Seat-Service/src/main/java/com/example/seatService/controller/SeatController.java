...
public class SeatController {
    ...
    //Get seats by class (ECONOMY/BUSINESS/FIRST)
    @GetMapping("/class")
    ...
    // Hold seat (temporary lock)
    @PutMapping("/hold/{seatId}")
    public SeatResponseDTO holdSeat(@PathVariable Long seatId) {
        return seatService.holdSeat(seatId);
    }

    // Release seat (cancel hold)
    @PutMapping("/release/{seatId}")
    public SeatResponseDTO releaseSeat(@PathVariable Long seatId) {
